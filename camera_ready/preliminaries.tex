...
Note, that the minimality \new{(and dually maximality) in this work} is with respect to the set inclusion and not wrt cardinality \new{as e.g. in the MaxSAT problem}. There can be multiple MIVCs with different cardinalities.
