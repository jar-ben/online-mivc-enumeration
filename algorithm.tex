...
%- pripomenout, ze kdyz zjistime, ze je set inadequate, tak automaticky vime, ze i vsechny jeho podmnoziny jsou inadequate. 
%- proto, cim vetsi je mnozina, o ktere zjistime ze je inadequate, tim vice informaci ziskame. 
%- proto se zamerujeme na hledani maximal inadequate subsets
%- rict, ze mozna varianta je najit nejaky inadequate a pak pomoci grow z nej ziskat maximalni inadequate. 
%- to je ale drahe a proto navrhujeme pouzit approximativni pristup
%
%- uvest algoritmus pro approx grow
%- slovne popsat
%
%- vlastnosti algoritmu: 
%-- vysledkem je inadequate set
%-- vysledny set byl pred zavolanim procedure unexplored nebo roven U.
...
%Note, that if a maximal unexplored subset is inadequate, then it is necessarily a MIS 
