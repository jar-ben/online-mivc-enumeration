...
Recall that if a set is determined to be inadequate then all of its subsets are necessarily also inadequate. Therefore, the larger the set that is determined to be inadequate, the more inadequate sets are explored.  %(due to the monotonicity of adequacy).
