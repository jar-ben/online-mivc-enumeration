...
\todo{Maybe some example? Mike and Elaheh, can you create some small example? Either based on the (optional) Motivating Example, or, if we wont have a motivating example, some other standalone example.}
