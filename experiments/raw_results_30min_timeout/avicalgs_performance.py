...
ucpr_time = reader['uc_time_w_proof_alg2']
proof_time = reader['proof_time_alg2']
uc_time = reader['uc_time_no_proof_alg2']
...
print("\n\nalgorithm 1 standard dv. runtime for models that terminated in 10 min: " + str(np.nanstd(term1_time)))
...
uc_dic = [] 
for indx, val in enumerate(numb_of_mivcs_alg4):
...
for item in sorted_dic:
    sorted_alg4.append(item['val'])
    sorted_alg3.append(numb_of_mivcs_alg3[item['id']])
    sorted_alg2.append(numb_of_mivcs_alg2[item['id']]) 

del sorted_dic

time_dic = [] 
for indx, val in enumerate(all_ivcs_timing_alg2):
    time_dic.append({'id': indx, 'val': val})

sorted_dic = sorted(time_dic, key=itemgetter('val'))  
del time_dic 
sorted_time4= []
sorted_time2 = []
sorted_time3 = [] 
for item in sorted_dic:
    sorted_time2.append(item['val'])
    sorted_time3.append(all_ivcs_timing_alg3[item['id']])
    sorted_time4.append(all_ivcs_timing_alg4[item['id']]) 
...
#plt.plot(x_axis, sorted_alg2, 'bx', markersize=4, label='#of MIVCs by Algorithm 2')  
#plt.plot(x_axis,  sorted_alg3, ':m', markersize=6, label='#of MIVCs by Algorithm 3') 
#plt.plot(x_axis,  sorted_alg4, 'ko', markersize=3, label='#of MIVCs by Algorithm 4')    
#plt.plot(x_axis,  proof_time, ':b', markersize=3, label='Verification time') 
#plt.plot(x_axis,  all_ivcs_timing_alg4, ':b+', markersize=4, label='Algorithm 4') 
#plt.plot(x_axis,  all_ivcs_timing_alg3, '--m', markersize=3, label='Algorithm 3') 
#plt.plot(x_axis,  all_ivcs_timing_alg2, ':gx', markersize=5, label='Algorithm 2') 
plt.plot(x_axis,  sorted_time4, ':b+', markersize=4, label='Algorithm 4') 
plt.plot(x_axis,  sorted_time3, '--m', markersize=3, label='Algorithm 3') 
plt.plot(x_axis,  sorted_time2, ':gx', markersize=5, label='Algorithm 2') 
